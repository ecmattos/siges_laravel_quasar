...
class MaterialsController extends Controller
{
    ...
    public function index()
    {
        ...
        $materials = $this->materialRepository->with(['material_unit', 'material_supply', 'warehouse'])->all();
    ...
    public function searchDescription(Request $request)
    {
        ...
        try {
            ...
            $materials = $this->materialRepository->with(['material_unit', 'material_supply', 'warehouse'])->materialsSearchDescription($srch_material_terms);
